...
//		System.out.println(EncryptUtils.encryptSalt("123456"));
		System.out.println(EncryptUtils.encryptSHA("9fPwh3Ak12345"));
		System.out.println(UUID.randomUUID().toString());
		System.out.println(EncryptUtils.encryptSHA(UUID.randomUUID().toString() + "12345"));
		System.out.println(EncryptUtils.encryptSHA("123459fPwh3Ak"));
		System.out.println(EncryptUtils.encryptPBKDF2("12345", "9fPwh3Ak".getBytes()));
//		System.out.println(DigestUtils.sha1Hex("9fPwh3Ak123456"));
//		System.out.println(DigestUtils.sha1Hex("1234569fPwh3Ak"));
//		System.out.println(EncryptUtils.encryptSHA("123"));
//		System.out.println(EncryptUtils.encryptSHA("1"));
